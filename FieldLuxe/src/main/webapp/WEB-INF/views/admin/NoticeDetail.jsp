...
<div class="main">
	<div class="show-table" style="font-family:Malgun Gothic;">
      ...
      <%-- <c:if test="${empty }"><h3>내역이 없습니다.</h3></c:if> --%>
         <tr>
            <th>제목</th>
            <td colspan="2">삼성카드로 결제시 30% 청구 할인 혜택!<%-- ${vo. } --%></td>
         </tr>
          <tr>
     		<th>게시일</th>
           	<td>2021.01.20<%-- ${vo. } --%></td>
           ...
           <tr>
           		<th>내용</th>
           		<td><textarea row="5" cols="120"><%-- ${vo. } --%></textarea></td>
           	</tr>
           	
            <%-- </c:forEach> --%>
          </table>
     	<a href="#" class="btn btn-default" style="background-color:#ffedf1;float:right;">목록</a>       			
      </div>
