	...
	<div class="show-table" style="font-family:Malgun Gothic;">
		...
		<tr>
            ...
            <td><input type="text" name="title" placeholder="제목을 입력하세요"
            	style="width:790px;height:30px;"></td>
         </tr>
           <tr>
           		<th>내용</th>
           		<td><textarea rows="10" cols="120" placeholder="내용을 입력하세요"></textarea></td>
           	</tr>
           </table>
          <div style="float:right;">
     	<button type="submit" class="btn btn-default" style="width:100px;background-color:#8284ff;color:white;margin-right:5px;" onclick="return confirm('등록하시겠습니까?')" >등록</button>      			
      	<button type="reset" class="btn btn-default" style="width:100px;background-color:#ebcee8;" onclick="goBack()">취소</button>
      	</div>
      </form>
      </div>
