...
<div class="show-table" >
   <table class="table">
       ...
       <c:forEach var="list" items="${reviewList}">
          <tr>
            <td>${list.reviewId}</td>
            <td><fmt:formatDate value="${list.reviewRegDate}" pattern="yyyy-MM-dd HH:mm"/></td>
            <td>${list.reviewTarget}</td>
            <td>${list.productName}</td>
            <td><div class="starRev" style="text-align:center;">
            	<c:if test="${list.reviewScore eq 5}">
            	...
            	<c:if test="${list.reviewScore eq 4}">
	                 <span class="starR on">별1</span>
	                 <span class="starR on">별2</span>
	                 <span class="starR on">별3</span>
	                 <span class="starR on">별4</span>
            	...
            	<c:if test="${list.reviewScore eq 3}">
	                 <span class="starR on">별1</span>
	                 <span class="starR on">별2</span>
	                 <span class="starR on">별3</span>
            	...
            	<c:if test="${list.reviewScore eq 2}">
	                 <span class="starR on">별1</span>
	                 <span class="starR on">별2</span>
            	...
            	<c:if test="${list.reviewScore eq 1}">
	                 <span class="starR on">별1</span>
            ...
            <td colspan="6" style="text-align:center;">
				...
				<c:if test="${pc.prev}">
					<li class="page-item"><a class="page-link"
						href="<c:url value='/review/reviewList${pc.makeURI(pc.beginPage - 1)}' />"
				...
				<c:forEach var="pageNum" begin="${pc.beginPage}" end="${pc.endPage}">
					<li class="page-item"><a
						href="<c:url value='/review/reviewList${pc.makeURI(pageNum)}'/>"
				...
				<c:if test="${pc.next}">
					<li class="page-item"><a class="page-link"
						href="<c:url value='/review/reviewList${pc.makeURI(pc.endPage + 1)}' />"
