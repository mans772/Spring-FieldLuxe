         ...
         <tr>
     	 ...
     	 <c:forEach var="list" items="${auctionList}">
     	 	<tr>
           	...
           	<td>
           		<a href="<c:url value="/trade/auctionDetail/${list.tradeVO.tradeId}" />">
           			<img style="height:120px;">${list.listData.productThumbnail}
           		</a>
           	</td>
            <td>${list.listData.productName}</td>
            <td>${list.listData.auctionEndDate}</td>
            <td>${list.dealData.auctionStatus}</td>
            </tr>
         </c:forEach>
            ...
            <td colspan="6" style="text-align:center;">
				...
				<c:if test="${pc.prev}">
					<li class="page-item"><a class="page-link"
						href="<c:url value='/trade/auctionList${pc.makeURI(pc.beginPage - 1)}' />"
				...
				<c:forEach var="pageNum" begin="${pc.beginPage}" end="${pc.endPage}">
					<li class="page-item"><a
						href="<c:url value='/trade/auctionList${pc.makeURI(pageNum)}'/>"
				...
				<c:if test="${pc.next}">
					<li class="page-item"><a class="page-link"
						href="<c:url value='/trade/auctionList${pc.makeURI(pc.endPage + 1)}' />"
