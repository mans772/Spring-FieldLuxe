...
<div class="contanier" style="font-family:Malgun Gothic;">
	...
	<h3 style="text-align:center;margin:30px 0;">상품 재등록</h3>
		...
		<h6 style="display:inline-flex;margin:35px;margin-left:20px;float:left;">모든 항목을 정확하게 기입하세요</h6>
			...
			<h6 style="display:inline-flex;margin-top:15px;margin-left:20px;float:left;">정품인증서를 반드시 첨부해주세요.</h6><br>
			 
			  <!-- 첨부 버튼 -->
            <div id="attach">
                <label class="waves-effect waves-teal btn-primary" for="uploadInputBox" style="height:30px;width:185px;background-color:#9facf5;">
			...
			<div>
				<h4 style="float:left;margin:30px 0;">판매자 한마디</h4>
				<table class="table">
					<tr>
						<td colspan="2">
